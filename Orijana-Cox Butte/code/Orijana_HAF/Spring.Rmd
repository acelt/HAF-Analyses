---
title: "Orijana Rock Creek - Spring"
output:
  html_document:
    df_print: paged
---
...
output_path <- "C:\\Users\\alaurencetraynor\\Documents\\2019\\Analysis\\OR\\2020\\Orijana-Cox Butte\\outputs\\April 2020\\Spring"

# Filename for ratings from analysis requestor
ratings_filename <- "HAF_Oregon_2020_OrijanaAllotment_NOCANALYSISREQUEST.xlsx"

# Core filename for all outputs
output_filename <- "Orijana_spring"
...
sampled_points <- sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                           layer = "terradat_spring_orij_final",
                           stringsAsFactors = FALSE)
...
design_points <- sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                           layer = "design_points_orij_spring_final",
                           stringsAsFactors = FALSE)
## Standardize projection
...
# Also add these full plot IDs to the ratinfs spreadsheet
...
sampled_points <- subset(sampled_points, unique_id!="Rock Creek Ranch")
```
### QC
```{r}
...
all_points[["reporting_unit"]] <- "Orijana_Spring"
point_weights[["reporting_unit"]] <- "Orijana_Spring"
...
## Make spatial 
wgtcat_spdf <- methods::as(wgtcat_spdf_simplified, "Spatial")
