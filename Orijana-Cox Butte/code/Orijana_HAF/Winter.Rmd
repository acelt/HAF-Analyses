---
title: "Orijana Rock Creek - Winter"
output:
  html_document:
    df_print: paged
---
...
output_filename <- "Orijana_winter"
...
sampled_points <- sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                           layer = "terradat_winter_orij_final",
                           stringsAsFactors = FALSE)
...
design_points <- sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                           layer = "design_points_orij_winter_final",
                           stringsAsFactors = FALSE)
## Standardize projection
...
all_points[["reporting_unit"]] <- "Orijana_Winter"
point_weights[["reporting_unit"]] <- "Orijana_Winter"
