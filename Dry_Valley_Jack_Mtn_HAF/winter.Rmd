---
title: "Dry Valley Jack Mtn Winter"
author: "Alex Traynor"
date: "8/24/2020"
...
output_filename <- "DryValleyJackMtn_winter"
...
invalid_fates = c("NN", NA, "Non Needed", "", "Not Sampled", "NT")
...
ratings <- readxl::read_excel(path = paste0(path_tabular, ratings_filename),
                             ...
                             col_types = c("text","text","text","date","text")) ## getting an error here based on column types so adding this in explicitly
...
lmf_points <- subset(lmf_points, grepl("^[0-9]{14}",lmf_points@data$unique_id))

aim_points <- subset(aim_points, !grepl("^[0-9]{14}",aim_points@data$unique_id))
```
