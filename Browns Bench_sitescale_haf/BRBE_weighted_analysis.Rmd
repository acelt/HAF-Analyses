---
title: "Brown Bench Site Scale HAF Weighted Analysis - Spring"
output:
  html_document:
    df_print: paged
---
...
output_path <- "C:\\Users\\alaurencetraynor\\Documents\\2019\\Analysis\\BrownsBenchSiteScaleHAF\\bb_sitescale_haf\\Analysis\\Proportional_Analysis_Request\\outputs\\Spring"
...
output_filename <- "brownsbench_analysis_spring"
...
jarbidge_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = "jarbidge_design_points_spring",
                                 stringsAsFactors = FALSE)
...
burly_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = "Burly_design_points_spring",
                                 stringsAsFactors = FALSE)
## Standardize projection
...
# Leaving out NV data here due to non-random implemntation and missing strata files
# NV file contains both 2011 and 2015 designs
elko_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = "elko_design_points_final_spring",
                                 stringsAsFactors = FALSE)
## Standardize projection
...
mhaf2017_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = "mhaf2017_design_points_spring",
                                 stringsAsFactors = FALSE)
## Standardize projection
...
mhaf2018_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = "mhaf2018_design_points_spring",
                                 stringsAsFactors = FALSE)
## Standardize projection
...
# LMF Segments
lmf_segments <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = segments,
                                 stringsAsFactors = FALSE)
## Standardize projection
lmf_segments <- sf::st_transform(lmf_segments,
                                      crs = projection)
## Make spatial
lmf_segments <- methods::as(lmf_segments, "Spatial")
```
...
sampled_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "All_sampled_plots_spring_join",
                           stringsAsFactors = FALSE)
## Standardize projection
...
### Burly
burly_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "burly_design_points_spring_final",
                           stringsAsFactors = FALSE)
## Standardize projection
burly_design_points <- sf::st_transform(burly_design_points,
                                crs = projection)
...
### Jarbidge
jarbidge_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "jarbidge_design_points_spring_final",
                           stringsAsFactors = FALSE)
## Standardize projection
jarbidge_design_points <- sf::st_transform(jarbidge_design_points,
                                crs = projection)
...
### MHAF 2017
mhaf2017_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "mhaf2017_design_points_spring_final",
                           stringsAsFactors = FALSE)
## Standardize projection
mhaf2017_design_points <- sf::st_transform(mhaf2017_design_points,
                                crs = projection)
...
### MHAF 2018
mhaf2018_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "mhaf2018_design_points_spring_final",
                           stringsAsFactors = FALSE)
## Standardize projection
mhaf2018_design_points <- sf::st_transform(mhaf2018_design_points,
                                crs = projection)
...
# need to standardise fate from MHAF designs
# based on plot tracking excel all MHAF 2017/2018 rejected plots were due to being in wrong stratum (i.e. Non-Target)
design_points$fate[design_points$fate=="Rejected"] <- "NT"
design_points$fate[design_points$fate=="Sampled"] <- "TS"
design_points$fate[design_points$fate=="Not Sampled"] <- "UNK"
design_points$fate[is.na(design_points$fate)] <- "UNK"
...
# looks like were missing 5 plots 
```
# Now combine:
