---
title: "Brown Bench Site Scale HAF Weighted Analysis - Allotment1 - Summer"
output:
  html_document:
    df_print: paged
---
...
output_path <- "C:\\Users\\alaurencetraynor\\Documents\\2019\\Analysis\\BrownsBenchSiteScaleHAF\\bb_sitescale_haf\\Analysis\\Proportional_Analysis_Request\\outputs\\Allotment1\\Summer"
...
output_filename <- "brownsbench_analysis_allot1_summer"
...
wgtcat_df <-sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                        layer = "poststrata_summer_allot1",
...
burly_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = "Burly_design_points_summer_allot1",
                                 stringsAsFactors = FALSE)
...
mhaf2018_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                                 layer = "mhaf2018_design_points_summer_allot1",
                                 stringsAsFactors = FALSE)
## Standardize projection
...
sampled_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "All_sampled_plots_summer_allot1",
                           stringsAsFactors = FALSE)
## Standardize projection
