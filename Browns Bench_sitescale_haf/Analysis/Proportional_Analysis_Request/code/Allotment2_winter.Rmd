---
title: "Brown Bench Site Scale HAF Weighted Analysis - Allotment2 - Winter"
output:
  html_document:
    df_print: paged
---
...
output_path <- "C:\\Users\\alaurencetraynor\\Documents\\2019\\Analysis\\BrownsBenchSiteScaleHAF\\bb_sitescale_haf\\Analysis\\Proportional_Analysis_Request\\outputs\\Allotment2\\Winter"
...
output_filename <- "brownsbench_analysis_allot2_winter"
...
wgtcat_df <-sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                        layer = "poststrata_winter_allot2",
...
sampled_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "All_sampled_plots_winter_allot2",
                           stringsAsFactors = FALSE)
...
burly_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "burly_design_points_winter_allot2",
                           stringsAsFactors = FALSE)
## Standardize projection
...
mhaf2018_design_points <- sf::st_read(dsn = paste(path_spatial, "BrownsBench Analysis.gdb", sep = "/"),
                           layer = "mhaf2018_design_points_winter_allot2",
                           stringsAsFactors = FALSE)
## Standardize projection
