...
output_filename <- "Antelope_BigLost_Summer"

# Column name in ratings spreadsheet
ratings_col_name <- "Suitability Upland Summer-S4"
...
strata <- "strata_AntelopeFlats_BigLost_summer_S4SeasonalHabitat_dissolve"

# name of sampled terradat points file in analysis gdb
terradat_file <- "tdat_AntelopeFlats_BigLost_summer_S4SeasonalHabitat_dissolve"

# name of sampled lmf points file in analysis gdb
lmf_file <-"lmf_AntelopeFlats_BigLost_summer_S4SeasonalHabitat_dissolve"

# name of design points file in analysis gdb
design_file <- "design_AntelopeFlats_BigLost_summer_S4SeasonalHabitat_dissolve"
...
mod_haf_points_2018 <- "modhaf2018_design_AntelopeFlats_BigLost_summer_S4SeasonalHabitat_dissolve"
mod_haf_points_2019 <- "modhaf2019_design_AntelopeFlats_BigLost_summer_S4SeasonalHabitat_dissolve"
haf_fate <- "EvalStatus"
haf_id <- "PLOTID"
```
