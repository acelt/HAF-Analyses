...
output_path <- "C:\\Users\\alaurencetraynor\\Documents\\2021\\Analysis\\ID\\Jim Sage HAF\\outputs\\"

# Filename for ratings from analysis requestor
ratings_filename <- "HAF_ID_2020_JimSage_SiteScale_RESULTS_01-19-2021.xlsx"

# Core filename for all outputs
output_filename <- "JimSage_summer"
...
path_spatial <- "C:\\Users\\alaurencetraynor\\Documents\\2021\\Analysis\\ID\\Jim Sage HAF\\inputs\\spatial\\"

# The geidatabase containing all the spatial files
analysis_gdb <- "Jim Sage Allotment HAF.gdb"

### The filepath to the folder where we have the Excel stuff
path_tabular <- "C:\\Users\\alaurencetraynor\\Documents\\2021\\Analysis\\ID\\Jim Sage HAF\\inputs\\"

### Spatial file names
# name of postratification file for this reporting unit
strata <- "strata_UpperRaftRiverValley_Summer_S4SeasonalHabitat"

# name of sampled terradat points file in analysis gdb
terradat_file <- "td_UpperRaftRiverValley_Summer_S4SeasonalHabitat"

# name of sampled lmf points file in analysis gdb
lmf_file <- "lmf_UpperRaftRiverValley_Summer_S4SeasonalHabitat"

# name of design points file in analysis gdb
design_file <- "design_UpperRaftRiverValley_Summer_S4SeasonalHabitat"
...
wgtcats[["wgtcat"]] <-  as.character(wgtcats[[wgtcats_var]])
...
sampled_points <- sampled_points[!is.na(sampled_points$wgtcat),]
```
# Now combine:
