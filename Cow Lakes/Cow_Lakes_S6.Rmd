...
output_path <- paste("C:/Users/alaurencetraynor/Documents/2019/Analysis/HAF/Cow lakes/output/",  ReportingUnit,date, sep = "_")
...
seasonal_habitat_type = "Winter.S6"
...
ratings <- ratings[!(ratings$Winter.S6==""), ]
...
ratings_tdat <- ratings %>% select(PrimaryKey, Plot.ID, Source, Project, Winter.S6, Visit.Date)  # trim to columns needed
...
wgtcats@data <- sp::merge(x = wgtcats@data[,c(1,2)],
