---
title: "Little Lost - Pahsimeroi - Summer"
output:
  html_document:
    df_print: paged
---
...
wgtcat_df <-sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                        layer = "LittleLost_Pahsimeroi_Summer_Strata",
...
sampled_points <- sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                           layer = "LMF_TerrADat_segments_strata_join_SummerRated",
                           stringsAsFactors = FALSE)
...
design1_points <- sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                           layer = "design_points_challis_summer_join",
                           stringsAsFactors = FALSE)
## Standardize projection
...
design2_points <- sf::st_read(dsn = paste(path_spatial, "SampleFrameCreation.gdb", sep = "/"),
                           layer = "design_points_uppersnake_summer_join",
                           stringsAsFactors = FALSE)
## Standardize projection
